class Jogo:
    ...
    def exibir (self):
        print(f"{self.id_jogo}, {self.título}, {self.console}, {self.genero}, {self.publisher}, {self.developer}, {self.critic_score}, {self.total_vendas}, {self.vendas_an}, {self.vendas_jp}, {self.vendas_eu}, {self.outras_vendas}, {self.data_lanc},")
